...
def update_yahoo_earnings(ticker_value):
    ...
    earnings_fig.add_trace(px.scatter(yahoo_earnings,x='Period',y='epsEstimate',
                            size='epsEstimate',
...
def update_finviz(ticker_value):
    ...
    fv_fig = px.histogram(finviz_ratings, x="rating",title=f"{name} 2021 Investment Bank Ratings",color_discrete_sequence=['navy'],labels={'rating':'Rating'})
